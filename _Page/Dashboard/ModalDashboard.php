                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            <select name="OrderBy" id="OrderBy" class="form-control">
                                ...
                                <option value="total_abk">Analisis Beban Kerja (ABK)</option>
                                <option value="total_asn">ASN</option>
                                <option selected value="total_kurang_guru">Kebutuhan Guru</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
...
<div class="modal fade" id="ModalDetailMap" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="index.php" method="GET">
                <div class="modal-header">
                    <h5 class="modal-title text-dark">
                        <i class="bi bi-info-circle"></i> Detail Map
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12" id="ShowDetailMap">
                            <!-- Peta muncul di sini -->
                        </div>
                    </div>
                </div>
