    ...
    if (!$Qry->execute()) {
        ...
        echo '
            ...
            <div class="row mb-2">
                ...
                <div class="col-1"><small>:</small></div>
                <div class="col-7">
                    <small class="text text-grayish">'.$JmlGuru.'</small>
                </div>
            </div>
            <div class="row mb-2">
                ...
                <div class="col-1"><small>:</small></div>
                <div class="col-7">
                    <small class="text text-grayish">'.$KurangGuru.'</small>
                </div>
            </div>
            <div class="row mb-2">
                ...
                <div class="col-1"><small>:</small></div>
                <div class="col-7">
                    <small class="text text-grayish">'.$JmlASN.'</small>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-4"><small>Kurang ASN</small></div>
                <div class="col-1"><small>:</small></div>
                <div class="col-7">
                    <small class="text text-grayish">'.$KrngASN.'</small>
                </div>
            </div>
        ';
    }
