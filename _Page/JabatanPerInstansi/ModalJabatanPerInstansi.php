                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8">
                            <select name="OrderBy" id="OrderBy" class="form-control">
                                ...
                                <option value="organization_code">Kode Instansi</option>
                                <option value="organization_name">Nama Instansi</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesTambah" autocomplete="off">
                <div class="modal-header">
                    <h5 class="modal-title text-dak"><i class="bi bi-plus"></i> Tambah Jabatan Per Instansi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="district_code"><small>Kab/Kota </small></label>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="organization_code"><small>Kode Instansi <i class="bi bi-exclamation-circle" title="Wajib Diisi"></i> </small></label>
                        </div>
                        <div class="col-md-8">
                            <input type="text" name="organization_code" id="organization_code" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label for="organization_name"><small>Nama Instansi <i class="bi bi-exclamation-circle" title="Wajib Diisi"></i> </small></label>
                        </div>
                        <div class="col-md-8">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark">
                    <i class="bi bi-info-circle"></i> Detail Jabatan Per Instansi
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesEdit">
                <div class="modal-header">
                    <h5 class="modal-title text-dark"><i class="bi bi-pencil"></i> Edit Jabatan Per Instansi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesHapus">
                <div class="modal-header">
                    <h5 class="modal-title text-dark">
                        <i class="bi bi-trash"></i> Hapus Jabatan Per Instansi
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
...
<div class="modal fade" id="ModalImport" tabindex="-1">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark">
                    <i class="bi bi-upload"></i> Import Jabatan Per Instansi
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                    ...
                    <div class="col-12 text-center">
                        <form id="ProsesImport" action="javascript:void(0);">
                            <div class="input-group">
                                <input type="file" name="data_jabatan_instansi" class="form-control" accept=".xlsx,.xls">
                                <a href="_Page/JabatanPerInstansi/Template-Jabatan-Per-Instansi.xlsx" class="btn btn-md btn-info" role="button" aria-label="Unduh Template Excel">
