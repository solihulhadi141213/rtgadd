...
function filterAndLoadTable() {
    ...
    $('#TabelJabatanPerInstansi').fadeOut(200, function () {
        $.ajax({
            type    : 'POST',
            url     : '_Page/JabatanPerInstansi/TabelJabatanPerInstansi.php',
            data    : ProsesFilter,
            success : function(data) {
                $('#TabelJabatanPerInstansi').html(data);

                // Setelah ganti konten → fadeIn lagi
                $('#TabelJabatanPerInstansi').fadeIn(200);
            }
        });
    });
}
...
$(document).ready(function() {
    ...
    $('#KeywordBy').change(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/JabatanPerInstansi/FormFilter.php',
    ...
    $('#province_code').change(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/JabatanPerInstansi/FormSelectDistrict.php',
    ...
    $('#ProsesTambah').submit(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/JabatanPerInstansi/ProsesTambah.php',
            data 	    :  data,
            cache       : false,
            processData : false,
            contentType : false,
    ...
    $('#ModalDetail').on('show.bs.modal', function (e) {
        var id_position_organization = $(e.relatedTarget).data('id');
        $('#FormDetail').html("Loading...");
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/JabatanPerInstansi/FormDetail.php',
            data        : {id_position_organization: id_position_organization},
            success     : function(data){
    ...
    $('#ModalEdit').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/JabatanPerInstansi/FormEdit.php',
            data        : {id_position_organization: id_position_organization},
            success     : function(data){
                $('#FormEdit').html(data);
                $('#NotifikasiEdit').html('');
    ...
    $('#ProsesEdit').submit(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/JabatanPerInstansi/ProsesEdit.php',
            data 	    :  data,
            cache       : false,
            processData : false,
            contentType : false,
    ...
    $('#ModalHapus').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/JabatanPerInstansi/FormHapus.php',
            data        : {id_position_organization: id_position_organization},
            success     : function(data){
                $('#FormHapus').html(data);
    ...
    $('#ProsesHapus').submit(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/JabatanPerInstansi/ProsesHapus.php',
            data 	    :  data,
            cache       : false,
            processData : false,
            contentType : false,
    ...
    $('#ModalExport').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/JabatanPerInstansi/FormExport.php',
            success     : function(data){
    ...
    $('#ProsesImport').submit(function(){
        $('#NotifikasiImport').html('<tr><td colspan="7" class="text-center"><small class="text-danger">Loading...</small></td></tr>');
        ...
        $.ajax({
            type: 'POST',
            url: '_Page/JabatanPerInstansi/ProsesImport.php',
            data: data,
            cache: false,
            processData: false,
            contentType: false,
            ...
            success: function(response){
                ...
                try {
                    ...
                    if (result.status === 'success') {
                        ...
                        $('#NotifikasiImport').html('<tr><td colspan="7" class="text-center"><small class="text-danger">' + result.message + '</small></td></tr>');
                        $('#btnImport').prop('disabled', false);
                        $('#progressSection').hide();
                    }
                } catch (e) {
            ...
            error: function(xhr, status, error) {
                ...
                $('#NotifikasiImport').html('<tr><td colspan="7" class="text-center"><small class="text-danger">Error: ' + error + '</small></td></tr>');
                $('#btnImport').prop('disabled', false);
                $('#progressSection').hide();
            }
        });
    ...
    function processBatchImport(fileToken, currentBatch, totalBatches, totalRows) {
        ...
        $.ajax({
            type: 'POST',
            url: '_Page/JabatanPerInstansi/ProsesImportBatch.php',
            data: {
                ...
                try {
                    ...
                    if (result.status === 'success') {
                        ...
                        if (currentBatch < totalBatches) {
                            ...
                            // Semua batch selesai
                            $('#NotifikasiImport').append('<tr><td colspan="7" class="text-center"><small class="text-success"><b>✅ SEMUA DATA BERHASIL DIPROSES</b></small></td></tr>');
                            $('#ResetFormImport').prop('disabled', false);
                            $('#btnImport').prop('disabled', false);
                            $('#progressSection').hide();
                            $("#ProsesFilter")[0].reset();
                        ...
                        $('#NotifikasiImport').html('<tr><td colspan="7" class="text-center"><small class="text-danger">Error pada batch ' + currentBatch + ': ' + result.message + '</small></td></tr>');
                        $('#btnImport').prop('disabled', false);
                        $('#progressSection').hide();
                    }
                } catch (e) {
                    console.log('Error parsing batch response:', e);
                    $('#NotifikasiImport').html('<tr><td colspan="7" class="text-center"><small class="text-danger">Error parsing response batch ' + currentBatch + '</small></td></tr>');
                    $('#btnImport').prop('disabled', false);
                    $('#progressSection').hide();
                }
            },
            error: function(xhr, status, error) {
                ...
                $('#NotifikasiImport').html('<tr><td colspan="7" class="text-center"><small class="text-danger">Error pada batch ' + currentBatch + ': ' + error + '</small></td></tr>');
                $('#btnImport').prop('disabled', false);
                $('#progressSection').hide();
            }
        });
