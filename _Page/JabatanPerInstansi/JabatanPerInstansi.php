<div class="pagetitle">
    <h1>
        <a href="">
            <i class="bi bi-database"></i> Jabatan Per Instansi</a>
        </a>
    </h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Jabatan Per Instansi</li>
        </ol>
    </nav>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <small>
                    Berikut ini adalah halaman pengelolaan database Jabatan Per Instansi. 
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th><small><b>Level</b></small></th>
                                    <th><small><b>Provinsi</b></small></th>
                                    <th><small><b>Kabupaten</b></small></th>
                                    <th><small><b>Instansi</b></small></th>
                                    <th><small><b>Jabatan</b></small></th>
                                    <th><small><b>Formasi PPG</b></small></th>
                                    <th><small><b>Opsi</b></small></th>
                                </tr>
                            </thead>
                            <tbody id="TabelJabatanPerInstansi">
                                <tr>
