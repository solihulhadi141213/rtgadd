    ...
    <div class="row">
            ...
            <div class="row mb-3">
                <div class="col-12 text-center">
                    <a href="" class="text-dark">
                        <h2 class="card-title">Halaman Pemulihan Akun</h2>
                    </a>
                </div>
            </div>
            <div class="row mb-3">
        ...
        <div class="col-md-4 mb-3">
            <form action="javascript:void(0);" class="row g-3" id="ProsesLupaPassword">
                ...
                <div class="row mt-3">
                    <div class="col-12" id="NotifikasiLupaPassword"></div>
                    <div class="col-12">
                        <button class="btn btn-lg btn-primary w-100" type="submit" id="TombolLupaPassword">
                            <i class="bi bi-send"></i> Kirim Kode
                        </button>
                    </div>
                    <div class="col-12">
