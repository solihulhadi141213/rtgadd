<div class="pagetitle">
    <h1>
        <a href="">
            <i class="bi bi-globe"></i> GeoJson (BPS)</a>
        </a>
    </h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">GeoJson (BPS)</li>
        </ol>
    </nav>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <small>
                    Berikut ini adalah halaman pengelolaan data referensi GeoJson yang bersumber dari API BPS. <br>
                    Endpoint Provinsi : https://sipedas.pertanian.go.id/api/wilayah/list_pro?thn=2025<br>
                    Endpoint Kab/Kota : https://sipedas.pertanian.go.id/api/wilayah/list_wilayah?thn=2025&lvl=11&pro=province_code&lv2=12<br>
                    Dokumentasi : https://sipedas.pertanian.go.id/api/wilayah/index<br>
                    GeoJson : https://whatsproject.my.id/geo/v1/prov/$province_code/map
