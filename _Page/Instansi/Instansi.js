...
function filterAndLoadTable() {
    ...
    $('#TabelInstansi').fadeOut(200, function () {
        $.ajax({
            type    : 'POST',
            url     : '_Page/Instansi/TabelInstansi.php',
            data    : ProsesFilter,
            success : function(data) {
                $('#TabelInstansi').html(data);

                // Setelah ganti konten → fadeIn lagi
                $('#TabelInstansi').fadeIn(200);
            }
        });
    });
}
...
$(document).ready(function() {
    ...
    $('#KeywordBy').change(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Instansi/FormFilter.php',
    ...
    $('#province_code').change(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Instansi/FormSelectDistrict.php',
    ...
    $('#ProsesTambah').submit(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Instansi/ProsesTambah.php',
            data 	    :  data,
            cache       : false,
            processData : false,
            contentType : false,
    ...
    $('#ModalDetail').on('show.bs.modal', function (e) {
        var id_organization = $(e.relatedTarget).data('id');
        $('#FormDetail').html("Loading...");
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Instansi/FormDetail.php',
    ...
    $('#ModalEdit').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Instansi/FormEdit.php',
            data        : {id_organization: id_organization},
            success     : function(data){
                $('#FormEdit').html(data);
                $('#NotifikasiEdit').html('');
    ...
    $('#ProsesEdit').submit(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Instansi/ProsesEdit.php',
            data 	    :  data,
            cache       : false,
            processData : false,
            contentType : false,
    ...
    $('#ModalHapus').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Instansi/FormHapus.php',
            data        : {id_organization: id_organization},
            success     : function(data){
                $('#FormHapus').html(data);
    ...
    $('#ProsesHapus').submit(function(){
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Instansi/ProsesHapus.php',
            data 	    :  data,
            cache       : false,
            processData : false,
            contentType : false,
    ...
    $('#ModalExport').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/Instansi/FormExport.php',
            success     : function(data){
    ...
    $('#ProsesImport').submit(function(){
        ...
        $.ajax({
            type: 'POST',
            url: '_Page/Instansi/ProsesImport.php',
            data: data,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function processBatchImport(fileToken, currentBatch, totalBatches, totalRows) {
        ...
        $.ajax({
            type: 'POST',
            url: '_Page/Instansi/ProsesImportBatch.php',
            data: {
